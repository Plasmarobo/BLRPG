...
we_basicpistol = WeaponTemplate.create(name: "Basic Pistol",	accuracy: 4, recoil: 0, range: 10, fire_mode: 0, damage: 1, secondary_damage: nil, cost: 20, description: "A basic weapon")
we_basicrevolver = WeaponTemplate.create(name: "Basic Revolver", accuracy: 3, recoil: 1, range: 15, fire_mode: 0, damage: 2, secondary_damage: nil, cost: 25, description: "A high powered pistol")
we_smg = WeaponTemplate.create(name: "SMG", accuracy: 2, recoil: 1, range: 10, fire_mode: 3, damage: 1, secondary_damage: nil, cost: 35, description: "A light, rapid weapon")
we_assaultrifle = WeaponTemplate.create(name: "Assault Rifle", accuracy: 4, recoil: 1, range: 20, fire_mode: 2, damage: 2, secondary_damage: nil, cost: 50, description: "An assault rifle")
we_sniperrifle = WeaponTemplate.create(name: "Sniper Rifle", accuracy: 5, recoil: 6, range: 100, fire_mode: 0, damage: 5, secondary_damage: nil, cost: 100, description: "A high powered longarm")
we_rocketlauncher = WeaponTemplate.create(name: "Rocket Launcher", accuracy: 3, recoil: 10, range: 50, fire_mode: 0, damage: 5, secondary_damage: 5, cost: 250, description: "Shoots explosive rockets. Secondary damage to all within 1 space of target.")
we_shotgun = WeaponTemplate.create(name: "Shotgun", accuracy: 2, recoil: 2, range: 20, fire_mode: 0, damage: 3, secondary_damage: 3, cost: 100, description: "A scattergun. Secondary damage to target if within 2.")
we_shank = WeaponTemplate.create(name: "Shank", accuracy: 1, recoil: 0, range: 0, fire_mode: 0, damage: 1, secondary_damage: nil, cost: 5, description: "A sharp length of metal")
we_knife = WeaponTemplate.create(name: "Knife", accuracy: 1, recoil: 0, range: 0, fire_mode: 0, damage: 2, secondary_damage: nil, cost: 25, description: "A utility knife")
we_vibromachete = WeaponTemplate.create(name: "VibroMachete", accuracy: 2, recoil: 1, range: 0, fire_mode: 0, damage: 2, secondary_damage: nil, cost: 35, description: "The blade vibrates at ultra high frequencies to slice through most materials")
we_thermokatana = WeaponTemplate.create(name: "ThermoKatana", accuracy: 2, recoil: 4, range: 0, fire_mode: 0, damage: 4, secondary_damage: nil, cost: 40, description: "The blade heats to high temperatures. Deals 1 point of damage as fire skill_typed")
we_magnahammer = WeaponTemplate.create(name: "MagnaHammer", accuracy: 1, recoil: 5, range: 0, fire_mode: 0, damage: 7, secondary_damage: nil, cost: 50, description: "A hammer with explosive power")
...
mi_hawk = MinionTemplate.create(name: "Hawk", max_hp: 3, max_armor: 0, max_shield: 0, speed: 5, actions: "Mark Target (1), Fly By (1)", size: "Small", description: "A fierce, feathered friend who spots targets.", is_beast: true)
mi_skag = MinionTemplate.create(name: "Skag", max_hp: 22, max_armor: 0, max_shield: 0, speed: 4, actions: "Bite(1), Spit (2)", size: "Medium", description: "An odd alien pet. Usually more of a pest.", is_beast: true)
mi_b3nkr = MinionTemplate.create(name: "B3NKR", max_hp: 60, max_armor: 5, max_shield: 2, speed: "3 (fly)", actions: "Turrets (3), Barriage (5)", size: "Large", description: "A beweaponed flying fortress.")
mi_warloader = MinionTemplate.create(name: "WarLoader", max_hp: 45, max_armor: 3, max_shield: 3, speed: 2, actions: "Cannons (2), Rockets (3)", size: "Large", description: "An armored robot with dual heavy cannons.")
mi_omegaskag = MinionTemplate.create(name: "Omega Skag", max_hp: 50, max_armor: 2, max_shield: 0, speed: 5, actions: "Bite(1), Charge (3)", size: "Large", description: "A large scag.", is_beast: true)

Prerequisite.create(skill_template_id: sk_carefulaim.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_steadyaim.id, prereq_type: 'skill', prereq_name: 'Careful Aim', value: 'Careful Aim')
Prerequisite.create(skill_template_id: sk_sniper.id, prereq_type: 'skill', prereq_name: 'Steady Aim', value: 'Steady Aim')
Prerequisite.create(skill_template_id: sk_cripplingshot.id, prereq_type: 'skill', prereq_name: 'Sniper', value: 'Sniper')
Prerequisite.create(skill_template_id: sk_deadeye.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_deadeye.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_sprayandpray.id, prereq_type: 'level', prereq_name: 'level', value: 3)
Prerequisite.create(skill_template_id: sk_itchytriggerfinger.id, prereq_type: 'skill', prereq_name: 'Spray and Pray', value: 'Spray and Pray')
Prerequisite.create(skill_template_id: sk_steadyhands.id, prereq_type: 'skill', prereq_name: 'Itchy Trigger Finger', value: 'Itchy Trigger Finger')
Prerequisite.create(skill_template_id: sk_cauterize.id, prereq_type: 'skill', prereq_name: 'Aid', value: 'Aid')
Prerequisite.create(skill_template_id: sk_defribulatinground.id, prereq_type: 'skill', prereq_name: 'Cauterize', value: 'Cauterize')
Prerequisite.create(skill_template_id: sk_summonally.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_summonally.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_summonpatron.id, prereq_type: 'skill', prereq_name: 'Summon Ally', value: 'Summon Ally')
Prerequisite.create(skill_template_id: sk_summonpatron.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_minionstrike.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_minionbounce.id, prereq_type: 'skill', prereq_name: 'Minion Strike', value: 'Minion Strike')
Prerequisite.create(skill_template_id: sk_minionchain.id, prereq_type: 'skill', prereq_name: 'Minion Bounce', value: 'Minion Bounce')
Prerequisite.create(skill_template_id: sk_minionchain.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_minionelement.id, prereq_type: 'skill', prereq_name: 'Minion Strike', value: 'Minion Strike')
Prerequisite.create(skill_template_id: sk_igneousminion.id, prereq_type: 'skill', prereq_name: 'Minion Element', value: 'Minion Element')
Prerequisite.create(skill_template_id: sk_chargedminion.id, prereq_type: 'skill', prereq_name: 'Minion Element', value: 'Minion Element')
Prerequisite.create(skill_template_id: sk_alkalineminion.id, prereq_type: 'skill', prereq_name: 'Minion Element', value: 'Minion Element')
Prerequisite.create(skill_template_id: sk_frostedminion.id, prereq_type: 'skill', prereq_name: 'Minion Element', value: 'Minion Element')
Prerequisite.create(skill_template_id: sk_slaggingminion.id, prereq_type: 'skill', prereq_name: 'Minion Element', value: 'Minion Element')
Prerequisite.create(skill_template_id: sk_minionprime.id, prereq_type: 'skill', prereq_name: 'Minion Strike', value: 'Minion Strike')
Prerequisite.create(skill_template_id: sk_minionprime.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_carefulminion.id, prereq_type: 'skill', prereq_name: 'Minion Strike', value: 'Minion Strike')
Prerequisite.create(skill_template_id: sk_carefulminion.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_deadlyminion.id, prereq_type: 'skill', prereq_name: 'Minion Strike', value: 'Minion Strike')
Prerequisite.create(skill_template_id: sk_deadlyminion.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_beastmaster.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_beastmaster.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_menagerie.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_menagerie.id, prereq_type: 'skill', prereq_name: ' Leve 5', value: ' Leve 5')
Prerequisite.create(skill_template_id: sk_synergisticlink.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_synergisticlink.id, prereq_type: 'level', prereq_name: 'level', value: 3)
Prerequisite.create(skill_template_id: sk_toughness.id, prereq_type: 'skill', prereq_name: 'Bulk', value: 'Bulk')
Prerequisite.create(skill_template_id: sk_musclebound.id, prereq_type: 'skill', prereq_name: 'Toughness', value: 'Toughness')
Prerequisite.create(skill_template_id: sk_bastion.id, prereq_type: 'skill', prereq_name: 'Bulk', value: 'Bulk')
Prerequisite.create(skill_template_id: sk_ironchurch.id, prereq_type: 'skill', prereq_name: 'Bastion', value: 'Bastion')
Prerequisite.create(skill_template_id: sk_flex.id, prereq_type: 'skill', prereq_name: 'Iron Church', value: 'Iron Church')
Prerequisite.create(skill_template_id: sk_onehandedwonder.id, prereq_type: 'skill', prereq_name: 'Bulk', value: 'Bulk')
Prerequisite.create(skill_template_id: sk_gunzerking.id, prereq_type: 'skill', prereq_name: 'One handed Wonder', value: 'One handed Wonder')
Prerequisite.create(skill_template_id: sk_rage.id, prereq_type: 'skill', prereq_name: 'Toughness', value: 'Toughness')
Prerequisite.create(skill_template_id: sk_unignorable.id, prereq_type: 'skill', prereq_name: 'Rage', value: 'Rage')
Prerequisite.create(skill_template_id: sk_unstoppable.id, prereq_type: 'skill', prereq_name: 'Rage', value: 'Rage')
Prerequisite.create(skill_template_id: sk_unbreakable.id, prereq_type: 'skill', prereq_name: 'Rage', value: 'Rage')
Prerequisite.create(skill_template_id: sk_hellhathnofury.id, prereq_type: 'skill', prereq_name: 'Rage', value: 'Rage')
Prerequisite.create(skill_template_id: sk_hellhathnofury.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_juggernaut.id, prereq_type: 'skill', prereq_name: 'Unbreakable', value: 'Unbreakable')
Prerequisite.create(skill_template_id: sk_juggernaut.id, prereq_type: 'skill', prereq_name: ' Rage', value: ' Rage')
Prerequisite.create(skill_template_id: sk_juggernaut.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_bullrush.id, prereq_type: 'skill', prereq_name: 'Tackle', value: 'Tackle')
Prerequisite.create(skill_template_id: sk_hammerthrow.id, prereq_type: 'skill', prereq_name: 'Bullrush', value: 'Bullrush')
Prerequisite.create(skill_template_id: sk_dodge.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_evasive.id, prereq_type: 'skill', prereq_name: 'Dodge', value: 'Dodge')
Prerequisite.create(skill_template_id: sk_dexterity.id, prereq_type: 'skill', prereq_name: 'Evasive', value: 'Evasive')
Prerequisite.create(skill_template_id: sk_uncannyreflex.id, prereq_type: 'skill', prereq_name: 'Dodge', value: 'Dodge')
Prerequisite.create(skill_template_id: sk_sideswipe.id, prereq_type: 'skill', prereq_name: 'Rush', value: 'Rush')
Prerequisite.create(skill_template_id: sk_murderchain.id, prereq_type: 'skill', prereq_name: 'Sideswipe', value: 'Sideswipe')
Prerequisite.create(skill_template_id: sk_toofasttolive.id, prereq_type: 'skill', prereq_name: 'Murder Chain', value: 'Murder Chain')
Prerequisite.create(skill_template_id: sk_canopener.id, prereq_type: 'skill', prereq_name: 'Piercing Strikes', value: 'Piercing Strikes')
Prerequisite.create(skill_template_id: sk_piercetheheavens.id, prereq_type: 'skill', prereq_name: 'Can Opener', value: 'Can Opener')
Prerequisite.create(skill_template_id: sk_piercetheheavens.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_elementalendurance.id, prereq_type: 'skill', prereq_name: 'Resistance', value: 'Resistance')
Prerequisite.create(skill_template_id: sk_hardy.id, prereq_type: 'level', prereq_name: 'level', value: 3)
Prerequisite.create(skill_template_id: sk_stoic.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_indominable.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_situationalawareness.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_pickpocket.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_plant.id, prereq_type: 'skill', prereq_name: 'Pickpocket', value: 'Pickpocket')
Prerequisite.create(skill_template_id: sk_sneakattack.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_decoy.id, prereq_type: 'skill', prereq_name: 'Finesse', value: 'Finesse')
Prerequisite.create(skill_template_id: sk_cripplingstrike.id, prereq_type: 'skill', prereq_name: 'Sneak Attack', value: 'Sneak Attack')
Prerequisite.create(skill_template_id: sk_weepingblade.id, prereq_type: 'skill', prereq_name: 'Crippling Strike', value: 'Crippling Strike')
Prerequisite.create(skill_template_id: sk_devestatingstrike.id, prereq_type: 'skill', prereq_name: 'Power Strike', value: 'Power Strike')
Prerequisite.create(skill_template_id: sk_apocalypsestrike.id, prereq_type: 'skill', prereq_name: 'Devestating Strike', value: 'Devestating Strike')
Prerequisite.create(skill_template_id: sk_supportdrone.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_medicalsuite.id, prereq_type: 'skill', prereq_name: 'Support Drone', value: 'Support Drone')
Prerequisite.create(skill_template_id: sk_defribulationcontacts.id, prereq_type: 'skill', prereq_name: 'Medical Suite', value: 'Medical Suite')
Prerequisite.create(skill_template_id: sk_assaultdrone.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_heavyloadout.id, prereq_type: 'skill', prereq_name: 'Assault Drone', value: 'Assault Drone')
Prerequisite.create(skill_template_id: sk_twincannons.id, prereq_type: 'skill', prereq_name: 'Assault Drone', value: 'Assault Drone')
Prerequisite.create(skill_template_id: sk_incindiaryloadout.id, prereq_type: 'skill', prereq_name: 'Heavy Loadout', value: 'Heavy Loadout')
Prerequisite.create(skill_template_id: sk_causticloadout.id, prereq_type: 'skill', prereq_name: 'Heavy Loadout', value: 'Heavy Loadout')
Prerequisite.create(skill_template_id: sk_highvoltageloadout.id, prereq_type: 'skill', prereq_name: 'Heavy Loadout', value: 'Heavy Loadout')
Prerequisite.create(skill_template_id: sk_geometrycoprocessor.id, prereq_type: 'skill', prereq_name: 'Heavy Loadout', value: 'Heavy Loadout')
Prerequisite.create(skill_template_id: sk_geometrycoprocessor.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_projectorarray.id, prereq_type: 'skill', prereq_name: 'Geometry Coprocessor', value: 'Geometry Coprocessor')
Prerequisite.create(skill_template_id: sk_remotedeliverysystem.id, prereq_type: 'skill', prereq_name: 'Geometry Coprocessor', value: 'Geometry Coprocessor')
Prerequisite.create(skill_template_id: sk_remotedeliverysystem.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_autonomy.id, prereq_type: 'skill', prereq_name: 'Assault Drone', value: 'Assault Drone')
Prerequisite.create(skill_template_id: sk_capacitors.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_microfusion.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_multitranseiver.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_multitranseiver.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_remotedigistruct.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_remotedigistruct.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_digistructwiz.id, prereq_type: 'skill', prereq_name: 'Remote Digistruction', value: 'Remote Digistruction')
Prerequisite.create(skill_template_id: sk_tacticaldrone.id, prereq_type: 'skill', prereq_name: 'Digistruct AI', value: 'Digistruct AI')
Prerequisite.create(skill_template_id: sk_overload.id, prereq_type: 'skill', prereq_name: 'Digistruct Operation', value: 'Digistruct Operation')
Prerequisite.create(skill_template_id: sk_parry.id, prereq_type: 'skill', prereq_name: 'Immediate Reaction', value: 'Immediate Reaction')
Prerequisite.create(skill_template_id: sk_phasepooling.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_phasestrike.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_phaselock.id, prereq_type: 'skill', prereq_name: 'Phase Strike', value: 'Phase Strike')
Prerequisite.create(skill_template_id: sk_phasejaunt.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_phaseshield.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_phaseshift.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_holdphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_holdphase.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_eridiumburn.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_incindiaryphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_incindiaryphase.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_causticphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_causticphase.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_shockingphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_shockingphase.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_cryogenicphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_cryogenicphase.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_phaseburst.id, prereq_type: 'skill', prereq_name: 'Phase Strike', value: 'Phase Strike')
Prerequisite.create(skill_template_id: sk_phaseburst.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_phasebond.id, prereq_type: 'skill', prereq_name: 'Summon Minion', value: 'Summon Minion')
Prerequisite.create(skill_template_id: sk_phasebond.id, prereq_type: 'skill', prereq_name: ' Sirenity', value: ' Sirenity')
Prerequisite.create(skill_template_id: sk_phasebond.id, prereq_type: 'skill', prereq_name: ' Phase Strike', value: ' Phase Strike')
Prerequisite.create(skill_template_id: sk_telephase.id, prereq_type: 'skill', prereq_name: 'Phase Strike', value: 'Phase Strike')
Prerequisite.create(skill_template_id: sk_telephase.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_etherialchains.id, prereq_type: 'skill', prereq_name: 'Telephase', value: 'Telephase')
Prerequisite.create(skill_template_id: sk_phasesyphon.id, prereq_type: 'skill', prereq_name: 'Phase Strike', value: 'Phase Strike')
Prerequisite.create(skill_template_id: sk_phasesyphon.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_sirenegrace.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_angelicgrace.id, prereq_type: 'skill', prereq_name: 'Sirene Grace', value: 'Sirene Grace')
Prerequisite.create(skill_template_id: sk_gracefulaura.id, prereq_type: 'skill', prereq_name: 'Angelic Grace', value: 'Angelic Grace')
Prerequisite.create(skill_template_id: sk_overdrivengrace.id, prereq_type: 'skill', prereq_name: 'Angelic Grace', value: 'Angelic Grace')
Prerequisite.create(skill_template_id: sk_overdrivengrace.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_directedgrace.id, prereq_type: 'skill', prereq_name: 'Angelic Grace', value: 'Angelic Grace')
Prerequisite.create(skill_template_id: sk_directedgrace.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_phasearmor.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_phasereflexes.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_finalphase.id, prereq_type: 'skill', prereq_name: 'Sirenity', value: 'Sirenity')
Prerequisite.create(skill_template_id: sk_finalphase.id, prereq_type: 'level', prereq_name: 'level', value: 12)
Prerequisite.create(skill_template_id: sk_turretbarrier.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_turretarmor.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_extrabarrel.id, prereq_type: 'skill', prereq_name: 'Assault Turrent', value: 'Assault Turrent')
Prerequisite.create(skill_template_id: sk_supportsystems.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_improvedoptics.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_extendedpowercell.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_extendedpowercell.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_explosiveshells.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_turretclamp.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_longbowsystems.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_longbowsystems.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_turrentshield.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_turrentshield.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_grenadesystem.id, prereq_type: 'skill', prereq_name: 'Assault Turret', value: 'Assault Turret')
Prerequisite.create(skill_template_id: sk_grenadesystem.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_rocketsystem.id, prereq_type: 'skill', prereq_name: 'Grenade System', value: 'Grenade System')
Prerequisite.create(skill_template_id: sk_devestatingdeploy.id, prereq_type: 'skill', prereq_name: 'Rocket System', value: 'Rocket System')
Prerequisite.create(skill_template_id: sk_devestatingdeploy.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_moderatelyarmored.id, prereq_type: 'skill', prereq_name: 'Lightly Armored', value: 'Lightly Armored')
Prerequisite.create(skill_template_id: sk_heavilyarmored.id, prereq_type: 'skill', prereq_name: 'Moderately Armored', value: 'Moderately Armored')
Prerequisite.create(skill_template_id: sk_incrediblestrength.id, prereq_type: 'skill', prereq_name: 'Heavily Armored', value: 'Heavily Armored')
Prerequisite.create(skill_template_id: sk_immovable.id, prereq_type: 'skill', prereq_name: 'Heavily Armored', value: 'Heavily Armored')
Prerequisite.create(skill_template_id: sk_walkingtank.id, prereq_type: 'skill', prereq_name: 'Heavily Armored', value: 'Heavily Armored')
Prerequisite.create(skill_template_id: sk_digistructplating.id, prereq_type: 'skill', prereq_name: 'Technomancy', value: 'Technomancy')
Prerequisite.create(skill_template_id: sk_digistructplating.id, prereq_type: 'skill', prereq_name: ' Moderately Armored', value: ' Moderately Armored')
Prerequisite.create(skill_template_id: sk_shieldbending.id, prereq_type: 'skill', prereq_name: 'Shield Link', value: 'Shield Link')
Prerequisite.create(skill_template_id: sk_shieldoverload.id, prereq_type: 'skill', prereq_name: 'Shield Overclocking', value: 'Shield Overclocking')
Prerequisite.create(skill_template_id: sk_shieldsyphon.id, prereq_type: 'skill', prereq_name: 'Shield Link', value: 'Shield Link')
Prerequisite.create(skill_template_id: sk_shieldnode.id, prereq_type: 'skill', prereq_name: 'Shield Link', value: 'Shield Link')
Prerequisite.create(skill_template_id: sk_shieldnode.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_shieldtxarray.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')
Prerequisite.create(skill_template_id: sk_shieldrxarray.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')
Prerequisite.create(skill_template_id: sk_shieldbattery.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')
Prerequisite.create(skill_template_id: sk_shieldnexus.id, prereq_type: 'skill', prereq_name: 'Shield TX Array', value: 'Shield TX Array')
Prerequisite.create(skill_template_id: sk_shieldnexus.id, prereq_type: 'skill', prereq_name: ' Shield RX Array', value: ' Shield RX Array')
Prerequisite.create(skill_template_id: sk_shieldnexus.id, prereq_type: 'level', prereq_name: 'level', value: 8)
Prerequisite.create(skill_template_id: sk_shieldcontrolvirus.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')
Prerequisite.create(skill_template_id: sk_shieldcontrolvirus.id, prereq_type: 'level', prereq_name: 'level', value: 5)
Prerequisite.create(skill_template_id: sk_shieldcoprocessor.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')
Prerequisite.create(skill_template_id: sk_shieldwatercooling.id, prereq_type: 'skill', prereq_name: 'Shield Node', value: 'Shield Node')

#Overrides
Prerequisite.create(skill_template_id: sk_sirenity, prereq_type: 'race', prereq_name: 'Siren', value: 'Siren')

Race.create(name: "Siren", description: "A mysterious being that’s not quite human. You are able to tap into Phase energy and manipulate it to a unique effect. Each siren is born with a different phase ability which evolves over time.\n
\nTraits:
\nAlmost Human: Sirens need to eat and breathe. Vulnerable to Fire.
\nPhasepool: Sirens may use Phase skills. Sirens start with the Sirenity skill.
\nEridium Affinity: Sirens gain the Eridium Affinity Skill.")
Race.create(name: "Human", description: "You’re soft, fleshy, but flexible and versatile. Human is generally the best choice for someone new to the game.
\nTraits:
\nUnfettered: You aren’t shackled by the demerits of technology and as such gain two extra proficiency points at level 1. 
\nOrganic Metabolism: You need to eat and breathe. Vulnerable to Fire.
\nUnderdog: Once per adventure a human may choose to reroll all non-success in a check.")
Race.create(name: "Cyborg", description: "Half machine, half human. You a stronger and faster than unaugmented humans. You also may also use and amplify cybernetics.
\nTraits:
\nAmped Action: Cyborgs may amp an action by spending hitpoints. Adding one die consumes 1 hit point. You may not add more die in this way than twice your current level.
\nBiomechanical: Your flesh is riddled with technology. Vulnerable to Shock.  
\nInterface: Cyborgs may use Augment skills.")
Race.create(name: "Robot", description: "All metal baby! You don’t have internal organs, and you run on only the finest pure electrons. Your metal shell provides you with some armor and technomancers might be able to give you a bit of a boost.
\nTraits:
\nChassis: Robots have 1 armor. This armor stacks with any additional armor. 
\nConstruct: Immune to Disease and Fire. Vulnerable to Corrosive. 
\nAI Core: Robots may use Automata skills.")